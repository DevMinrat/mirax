    ...
    _createClass(ItcTabs, [{
      ...
      value: function _init() {
        ...
        this._elButtons.forEach(function (el, index) {
          ...
          _this2._elPanes[index].setAttribute("role", "tabpanel");

          _this2._elPanesAddl[index].setAttribute("role", "tabpanel");
        });
      }
    }, {
      key: "show",
      value: function show(elLinkTarget) {
        ...
        var elPaneAddlTarget = this._elPanesAddl[elLinkTarget.dataset.index];

        var elLinkActive = this._elTabs.querySelector(".tabs-btn_active");

        var elPaneShow = this._elTabs.querySelector(".tabs-pane_show");

        var elPaneAddlShow = this._elTabs.querySelector(".tabs-pane_addl_show");
      ...
      value: function _events() {
        ...
        this._elTabs.addEventListener("click", function (e) {
          var target = e.target.closest(".tabs-btn");
  ...
  if (modalTriggers.length > 0) {
    modalTriggers.forEach(function (el) {
      el.addEventListener("click", function () {
        ...
        var modal = document.querySelector("[data-modalName='".concat(modalName, "']"));
